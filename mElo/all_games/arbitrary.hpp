...
// you can use this file to evaluate arbitrary games with the file thats in the "assets/games.csv" file
...
namespace arbitrary {
	...
	inline std::vector<game> init_game_list() {
	...
	inline void save_melo(Matrix& MELO) {
		// save the melo and elo to csv files
		{
	...
	inline void save_elo(Matrix& ELO) {
		{
