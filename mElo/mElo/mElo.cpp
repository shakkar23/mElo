...
#include <vector>
#include <algorithm>
#include "construct_omgea.hpp"


mELO_rating mELO(DataFrame match_data, DataFrame init_data, Matrix init_c_mat, Numeric init_rating = 1500, int k = 1, Numeric eta_1 = 27, Numeric eta_2 = 1, Numeric p1_advantage = 0, bool save_history = true, bool sort = true) {

	// these are the identifiers for the players
	std::vector<size_t> players;
	
    // these are the number of players and the number of time periods
	size_t n_players;
	size_t n_times;
